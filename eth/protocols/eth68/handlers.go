...
func handleGetBlockHeaders(backend eth.Backend, msg Decoder, peer *eth.Peer) error {
...
func ServiceGetBlockHeadersQuery(chain *core.BlockChain, query *GetBlockHeadersRequest, peer *eth.Peer) []rlp.RawValue {
	if query.Skip == 0 {
...
func serviceNonContiguousBlockHeaderQuery(chain *core.BlockChain, query *GetBlockHeadersRequest, peer *eth.Peer) []rlp.RawValue {
...
func handleGetBlockBodies(backend eth.Backend, msg Decoder, peer *eth.Peer) error {
...
func handleGetReceipts(backend eth.Backend, msg Decoder, peer *eth.Peer) error {
...
func handleNewBlockhashes(backend eth.Backend, msg Decoder, peer *eth.Peer) error {
	...
	ann := new(eth.NewBlockHashesPacket)
...
func handleBlockHeaders(backend eth.Backend, msg Decoder, peer *eth.Peer) error {
	...
	return peer.DispatchResponse(eth.NewResponse(res.RequestId, BlockHeadersMsg, &res.BlockHeadersRequest), metadata)
}
...
func handleBlockBodies(backend eth.Backend, msg Decoder, peer *eth.Peer) error {
	...
	return peer.DispatchResponse(eth.NewResponse(res.RequestId, BlockBodiesMsg, &res.BlockBodiesResponse), metadata)
}
...
func handleReceipts(backend eth.Backend, msg Decoder, peer *eth.Peer) error {
	...
	return peer.DispatchResponse(eth.NewResponse(res.RequestId, ReceiptsMsg, &res.ReceiptsResponse), metadata)
}
...
func handleGetPooledTransactions(backend eth.Backend, msg Decoder, peer *eth.Peer) error {
...
func answerGetPooledTransactions(backend eth.Backend, query GetPooledTransactionsRequest) ([]common.Hash, []rlp.RawValue) {
